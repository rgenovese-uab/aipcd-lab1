...
PATH_KA_DV=$PWD
TESTS_DIR="/eda/verification/lagarto-ka-dv/random_tests/regression/complete/complete_ranktest/bin"
TESTS_PATH="/eda/verification/lagarto-ka-dv/random_tests/regression/complete"
...
cd ${PATH_KA_DV}/regress/results/ka_selected_complete_tests/
