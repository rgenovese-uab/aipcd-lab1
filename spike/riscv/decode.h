...
#define require_vector(alu) \
  do { \
    require_vector_vs; \
    if (P.core_type != SARGANTANA) require_extension('V'); \
    require(!P.VU.vill); \
...
#define set_fp_exceptions ({ if (softfloat_exceptionFlags) { \
                               ...
                               STATE.last_fflags |= softfloat_exceptionFlags; \
                             } \
...
#define DEBUG_START             0x10000
#define DEBUG_END               (0x10020 - 1)

#define DISABLE_PGSIZE_CHECK    1
