...
private:
  ...
  void interactive_mip(const std::string& cmd, const std::vector<std::string>& args);
  void interactive_set_freg(const std::string& cmd, const std::vector<std::string>& args);
