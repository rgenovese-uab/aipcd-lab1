...
#define CSR_SMD 0x801
#define CSR_TO_HOST 0x9f0
#define CSR_FROM_HOST 0x9f1
#define CSR_CLEARMIP 0x9f2
#define CSR_MBOOT_MAIN_ID 0xfc0
...
DECLARE_CSR(gmx_p, CSR_GMX_P)
DECLARE_CSR(gmx_tb_lo, CSR_GMX_TB_LO)
DECLARE_CSR(gmx_tb_hi, CSR_GMX_TB_HI)
DECLARE_CSR(gmx_pos, CSR_GMX_POS)
DECLARE_CSR(gmx_save, CSR_GMX_SAVE)
...
DECLARE_CSR(smd, CSR_SMD)
DECLARE_CSR(csr_tohost, CSR_TO_HOST)
DECLARE_CSR(csr_fromhost, CSR_FROM_HOST)
DECLARE_CSR(csr_clearmip, CSR_CLEARMIP)
DECLARE_CSR(mboot_main_id, CSR_MBOOT_MAIN_ID)
#endif
#ifdef DECLARE_CAUSE
